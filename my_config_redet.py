...
data_root = '/home/shai/Desktop/sat_vision_data/train_dataset/split_640_640'
img_norm_cfg = dict(
    type='Normalize',
...
data = dict(
    ...
    train=dict(
        ...
        version='le90',
        data_root=
        '/home/shai/Desktop/sat_vision_data/train_dataset/split_640_640/train'
    ),
    val=dict(
        type='MAFATDataset',
        ann_file='labelTxt',
        ...
        version='le90',
        data_root=
        '/home/shai/Desktop/sat_vision_data/train_dataset/split_640_640/val'),
    test=dict(
        type='MAFATDataset',
        ann_file='labelTxt',
        img_prefix='images',
